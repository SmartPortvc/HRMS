...
import { Upload, History, Users, FileText, FileSpreadsheet, LogOut, UserIcon, User, IndianRupee, Bell } from 'lucide-react';
        ...
        {user?.role === 'department_admin' && (
          <>
            ...
            <button
              ...
              className={`flex items-center space-x-2 w-full px-4 py-2 rounded-lg transition-colors ${
                currentView === 'department-salary' ? 'bg-white/20' : 'hover:bg-white/10'
              }`}
            >
              <IndianRupee size={20} />
